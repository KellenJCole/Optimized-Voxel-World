...
bool VertexBuffer::isValid() { return valid; }
...
void VertexBuffer::Bind() const { GLCall(glBindBuffer(GL_ARRAY_BUFFER, vertexBuffer_id)); }

void VertexBuffer::Unbind() const { GLCall(glBindBuffer(GL_ARRAY_BUFFER, 0)); }

VertexBuffer::~VertexBuffer() { destroy(); }

unsigned int VertexBuffer::GetCount() { return m_count; }
